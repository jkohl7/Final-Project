...
{
    public partial class NorthwindConsole_32_JMKContext : DbContext
    {
        public NorthwindConsole_32_JMKContext()
        {
        }

        public NorthwindConsole_32_JMKContext(DbContextOptions<NorthwindConsole_32_JMKContext> options)
            : base(options)
        {
        }
